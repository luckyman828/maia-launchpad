export default function Footer() {
    return (
        ...
        //                 <img className="block lg:hidden h-8 w-auto" src="../assets/img/logo.svg" alt="Workflow"/>
        //                 <img className="hidden lg:block h-8 w-auto" src="../assets/img/logo-lg.svg" alt="Workflow"/>
            ...
            <div className="container mx-auto mt-12 mb-12">
                <div className="grid grid-cols-6 gap-4 footer-responsive">
                    <div className="col-start-1 col-end-3 max-w-xs">
                        <div className="flex-shrink-0 flex items-center">
                            <img className="opacity-75 block lg:hidden h-8 w-auto" src="../assets/img/logo.svg" alt="Workflow"/>
                            <img className="opacity-75 hidden lg:block h-8 w-auto" src="../assets/img/logo-lg.svg" alt="Workflow"/>
